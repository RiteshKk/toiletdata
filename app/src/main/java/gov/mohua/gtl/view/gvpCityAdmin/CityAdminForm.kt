...
class CityAdminForm : AppCompatActivity(), View.OnClickListener,gov.mohua.gtl.location.OnLocationChangeCallBack {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        categoryList.adapter =gov.mohua.gtl.controller.CategoryListAdapter(this,android.R.layout.simple_spinner_dropdown_item,catList)
        ...
        selected_ward.text=intent?.getStringExtra(C.SELECTED_WARD)
