...
import gov.mohua.gtl.view.thirdParty.fragments.AdditionalFragment
import gov.mohua.gtl.view.thirdParty.fragments.DesirableFragment
import gov.mohua.gtl.view.thirdParty.fragments.EssentialFragment
import gov.mohua.gtl.view.thirdParty.fragments.MandatoryFragment
import org.json.JSONArray
import org.json.JSONObject

class CTPTFormDetails : AppCompatActivity(),gov.mohua.gtl.OnFragmentChangeListener {
    private val globalList = ArrayList<gov.mohua.gtl.model.QuestionData>()
    ...
    private lateinit var binding:gov.mohua.gtl.databinding.ActivityCtptformDetailsBinding
    ...
    private fun populateAdditionalDataList(): ArrayList<gov.mohua.gtl.model.QuestionData> {
        val dataList: ArrayList<gov.mohua.gtl.model.QuestionData>
        val groupListType = object : TypeToken<ArrayList<gov.mohua.gtl.model.QuestionData>>() {}.type
        dataList = Gson().fromJson(C.additionalData, groupListType)
        return dataList
    }

    private fun populateEssentialDataList(): ArrayList<gov.mohua.gtl.model.QuestionData> {
        val dataList: ArrayList<gov.mohua.gtl.model.QuestionData>
        val groupListType = object : TypeToken<ArrayList<gov.mohua.gtl.model.QuestionData>>() {}.type
    ...
    private fun populateDesiableDataList(): ArrayList<gov.mohua.gtl.model.QuestionData> {
        val dataList: ArrayList<gov.mohua.gtl.model.QuestionData>
        val groupListType = object : TypeToken<ArrayList<gov.mohua.gtl.model.QuestionData>>() {}.type
    ...
    private fun populateMandatoryDataList(): ArrayList<gov.mohua.gtl.model.QuestionData> {
        val dataList: ArrayList<gov.mohua.gtl.model.QuestionData>
        val groupListType = object : TypeToken<ArrayList<gov.mohua.gtl.model.QuestionData>>() {}.type
