...
import gov.mohua.gtl.controller.NodalOfficerWardDetailsAdapter
...
class NodalOfficerWardList : AppCompatActivity(),gov.mohua.gtl.events.OnCaptureButtonClickedListener,gov.mohua.gtl.location.OnLocationChangeCallBack {
    var position: Int = 0
