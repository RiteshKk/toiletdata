...
class EssentialFragment : Fragment(),gov.mohua.gtl.events.OnRadioButtonClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.detailsViewRecycler.adapter =gov.mohua.gtl.controller.CTPTDetailsAdapter(list,this)
