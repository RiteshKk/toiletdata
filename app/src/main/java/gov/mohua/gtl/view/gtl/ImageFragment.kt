...
class ImageFragment : Fragment(), View.OnClickListener,gov.mohua.gtl.location.OnLocationChangeCallBack {
    ...
    private var locationAPI: gov.mohua.gtl.location.LocationAPI? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        locationAPI =gov.mohua.gtl.location.LocationAPI(activity,this)
    }
