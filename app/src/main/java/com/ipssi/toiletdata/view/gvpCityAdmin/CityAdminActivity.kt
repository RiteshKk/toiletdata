...
import com.ipssi.toiletdata.view.nodalOfficer.NodalOfficerWardList
...
class CityAdminActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ward_list.adapter = CategoryListAdapter(this, android.R.layout.simple_spinner_dropdown_item, catList)
        ward_list.setOnItemSelectedListener(object : AdapterView.OnItemSelectedListener {
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        if (item?.itemId == R.id.menu_logout) {
            ...
            var intent = Intent(this@CityAdminActivity, ShowCityAdminData::class.java)
